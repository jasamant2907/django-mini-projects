...
class Battles(models.Model):
    ...
    major_death = models.TextField(blank=True, null=True)  # This field type is a guess.
    major_capture = models.TextField(blank=True, null=True)  # This field type is a guess.
    attacker_size = models.BigIntegerField(blank=True, null=True)
    defender_size = models.BigIntegerField(blank=True, null=True)
    attacker_commander = models.CharField(max_length=100, blank=True, null=True)
    defender_commander = models.CharField(max_length=200, blank=True, null=True)
    summer = models.TextField(blank=True, null=True)  # This field type is a guess.
